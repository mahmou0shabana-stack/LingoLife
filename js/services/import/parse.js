...
export function parsePackage(input) {
  ...
  return {
    ...
    pkg: {
      ...
      /*
       * ⚠️ **معرّف الذكرى التي خرج من أجلها طلب التحليل** *(WS6-ب)*.
       *    اختياريّ: حزمةٌ من أي مصدرٍ آخر لا تحمله وتمرّ كما هي.
       *
       *    وهو **هويّةٌ لا مطابقةُ اسم**. الخطّة تفترض الإنشاء دائمًا
       *    لأن ذكريتين بنفس العنوان شيئان مختلفان — لكن ردًّا يحمل
       *    المعرّف نفسه الذي أرسلناه لا يخمّن أيّهما، بل يعرف.
       *
       *    ويبقى ظاهرًا في المعاينة قابلًا للتغيير: معلومةٌ أدقّ لا
       *    بابٌ يتخطّى المراجعة.
       */
      forSceneId: typeof body.forSceneId === 'string' ? body.forSceneId : null,
    },
  };
}
