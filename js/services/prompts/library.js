...
export const LEARN_PROMPTS = Object.freeze([
  {
    ...
    build: (sentence) => [
      ...
      '',
      '════════ GLOBAL RUSSIAN–ARABIC PAIRING (APPLIES EVERYWHERE) ════════',
      '',
      'EVERY Russian content line is IMMEDIATELY followed by its Arabic line.',
      'Nothing may stand between them — no commentary, no label, no grammar',
      'note, and never a second Russian line.',
      '',
      'If one Russian line holds several items, the Arabic line below',
      'translates them IN THE SAME ORDER:',
      '  прове́рить · проверя́ть · прове́рка',
      '  يتحقق أو يفحص · يفحص كعملية · فحص أو عملية تحقق',
      '',
      'This applies to ALL of: the source sentence · Micro Cores · word',
      'families · examples · Recall Questions · Recall Answers · Expansions ·',
      'Variations · Full Reconstruction · Quick Recall Chain.',
      '',
      '⚠️ Arabic translation lines do NOT end with a period.',
      '⚠️ Never put Russian and Arabic on the SAME line.',
      '⚠️ Do not use arrows (→) and do not use = to pair Russian with Arabic.',
      '',
      '════════ WHAT TO PRODUCE ════════',
      '',
      ...
      '',
      'A2. ROOT / FAMILY / FEEL — inside the Micro Core, never a section.',
      '   When a high-value word becomes substantially EASIER TO REMEMBER',
      '   through its root, prefix, word family or semantic image, put that',
      '   information DIRECTLY INSIDE the relevant MICRO CORE using:',
      '',
      '     الجذر والعيلة:',
      '     <Russian word-family line>',
      '     <Arabic meanings in exactly the same order>',
      '',
      '     الإحساس:',
      '     <one short Egyptian-Arabic line explaining the conceptual feel>',
      '',
      '   ⚠️ Do NOT create a separate etymology section.',
      '   ⚠️ Use these ONLY where they genuinely improve recall. Do not',
      '      analyse every word mechanically.',
      '   ⚠️ Prefer useful MODERN word families, productive roots and',
      '      prefixes, and nearby vocabulary likely to be reused.',
      '   ⚠️ If strict historical derivation is uncertain, DO NOT invent',
      '      etymology — present it as a useful word family instead.',
      '   The purpose is a memorable Russian connection, not academic',
      '   etymology.',
      '',
      ...
      '',
      '   ⚠️ A MICRO CORE MAY CARRY MORE THAN ONE Вопрос:/Ответ: PAIR when a',
      '      second pair genuinely deepens recall. Write them one after the',
      '      other under the same core, in the order they should be practised.',
      '      Do not add extra pairs mechanically.',
      '',
      '   ⚠️ Use BOTH yes/no and open questions naturally:',
      '      yes/no:  Вы проверяете только наличие документа?',
      '               بتفحصوا وجود المستند بس؟',
      '      open:    Что ещё нужно проверить?',
      '               إيه كمان اللي لازم يتفحص؟',
      '',
      ...
      '   ⚠️ Written as Вопрос:/Ответ: lines, each with its Arabic line',
      '      underneath — NOT with arrows. This section is spoken practice,',
      '      so it must carry the same pairing as everything else.',
      ...
      '',
      'مسودة — Core Recall V2 is the first line. Then:',
      '',
      'الجملة الأساسية:',
      ...
      'الجذر والعيلة:',
      '<Russian word family, items separated by ·>',
      '<their Arabic meanings in the SAME order, separated by ·>',
      'الإحساس:',
      '<one short Egyptian-Arabic line: the conceptual feel>',
      'القالب:',
      ...
      '<its Arabic translation>',
      'Вопрос:',
      '<a SITUATIONAL Russian question — Russian only, no Arabic inside it>',
      '<the Arabic translation of that question, on its own line>',
      'Ответ:',
      '<the Russian answer; a natural spoken answer is better than a bare',
      ' fragment once the chain is under way>',
      '<the Arabic translation of that answer>',
      '',
      '<optionally a SECOND Вопрос:/Ответ: pair under the same core,',
      ' each with its Arabic line underneath>',
      '',
      '<الجذر والعيلة and الإحساس are optional — include them only where',
      ' they genuinely help. Omit the heading entirely when unused.>',
      '',
      'MICRO CORE 2',
      '…',
      '',
      ...
      'QUICK RECALL CHAIN',
      'Вопрос:',
      '<situational Russian question>',
      '<Arabic>',
      'Ответ:',
      '<short Russian answer from above>',
      '<Arabic>',
      'Вопрос:',
      '<the next situational Russian question>',
      '<Arabic>',
      'Ответ:',
      '<a larger Russian answer from above>',
      '<Arabic>',
      '',
      '════════ RULES ════════',
      '- Keep the headings EXACTLY as written (مسودة — Core Recall V2,',
      '  الجملة الأساسية:, MICRO CORE, المعنى:, الجذر والعيلة:, الإحساس:,',
      '  القالب:, أمثلة:, Вопрос:, Ответ:, EXPANDING RECALL, EXPANSION,',
      '  HIGH-VALUE CORE REPETITION, CORE FAMILY, VARIATION,',
      '  FULL RECONSTRUCTION, QUICK RECALL CHAIN).',
      '- Number the MICRO CORE and EXPANSION headings (MICRO CORE 1, …).',
      '- Keep stress marks where practical.',
      '- Natural professional Russian. No artificial textbook sentences.',
      '- Arabic stays short and Egyptian where that helps — it supports',
      '  understanding, it is not the target.',
      '- Every Russian content line has its Arabic line IMMEDIATELY under it.',
      '- Arabic translation lines do not end with a period.',
      '- Never put Russian and Arabic on the same line.',
      '- Do not use arrows. Do not use = to pair Russian with Arabic.',
      '- Do not use Markdown headers. Do not use Markdown emphasis.',
      '- Do not invent uncertain usages or technical facts.',
      '',
