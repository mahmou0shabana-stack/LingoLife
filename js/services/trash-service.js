...
export const NOT_TRASHABLE = Object.freeze({
  ...
  eventTypes: 'يُؤرشَف أو يُدمَج — الحذف يترك ذكرياتك بلا نوع (بند 8)',
  /* ⚠️ نفسُ حجّة الأنواع بالحرف: الرابطُ يحمل معرّف التصنيف، فحذفُه
     يترك تسجيلاتٍ تشير إلى لا شيء. يُؤرشَف فيختفي من الاختيار وتبقى
     تسجيلاتُه تُعرَض باسمه. */
  audioRoles: 'يُؤرشَف لا يُحذف — الحذف يترك تسجيلاتك بلا تصنيف',
  eventThreads: 'يُؤرشَف — والمشاهد مستقلّة عنه أصلًا فلا تتأثّر (بند 27)',
  ...
  /*
   * ⚠️ **فهرسٌ مشتقٌّ لا محتوى** (WS-C، بندا ٥٥ و٥٦). صفوفُه تُبنى من
   *    `scripts` و`studyDrafts` وتُعاد بنداءِ «أعِد بناء الفهرس».
   *    فسلّةٌ تعرض «موضع كلمة في جملة ٣» لا معنى لها — والمحذوفُ
   *    الحقيقيُّ هو السكريبت، وحذفُه يُسقط مواضعَه معه.
   */
  memoryOccurrences: 'فهرسٌ مشتقٌّ يُعاد بناؤه — المحذوفُ هو المصدر لا الموضع',

  /*
   * ⚠️ **ذاكرةُ اللغة v2: ثلاثةٌ خارج السلّة، ولكلٍّ سببٌ مختلف** (WS-J).
   *
   *   `memorySources`     ليس محتوًى بل **حالةُ تحليلِ** محتوًى. والمحذوفُ
   *                       الحقيقيُّ هو النصّ؛ وحذفُ سطر الحالة وحدَه يعني
   *                       نسيانَ أنك حلّلتَه فيُعاد تحليلُه بلا سبب. وحين
   *                       يُحذف النصُّ يُعلَّم سطرُه `missing` وتُبنى منه
   *                       شهادةُ الحذف — فهو **يشهد على الحذف** لا يُحذف.
   *
   *   `analysisItems`     يُزال بإلغاء تحليلٍ كامل لا بحذف مفردةٍ من قائمة.
   *                       وسلّةٌ فيها «согласование» بلا سياقٍ لا تُقرأ.
   *
   *   `analysisEvidence`  وصلةُ دليلٍ تتبع عنصرَها ونصَّها معًا.
   */
  memorySources: 'حالةُ تحليلٍ لا محتوًى — المحذوفُ هو النصّ، وسطرُه يشهد على حذفه',
  analysisItems: 'عنصرُ تحليلٍ يُزال بإلغاء التحليل لا بحذفٍ مفرد',
  analysisEvidence: 'وصلةُ دليلٍ تتبع عنصرَها ونصَّها',
