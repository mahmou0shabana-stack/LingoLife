  ...
  return {
    ...
    async isAvailable() {
      return {
        ...
        /*
         * ⚠️ **السببُ الحقيقيّ، لا «قريبًا»**: لا خدمةَ خلفه في هذا البناء،
         *    وتشغيلُه يحتاج خادمًا خلفيًّا يحمل مفتاحَ المزوّد — والمفتاحُ لا
         *    يوضع في تطبيق الواجهة أبدًا (يُقرأ من أيّ جهازٍ يفتحه).
         */
        reason: 'لا خدمةَ سحابيّة موصولة — يحتاج خادمًا خلفيًّا يحمل مفتاحَ مزوّد الصوت (لا يوضع المفتاحُ في التطبيق نفسِه)',
      };
    },
